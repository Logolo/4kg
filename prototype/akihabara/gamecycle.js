	...
	return gbox.addObject({
		...
		gameIntroAnimation:function(reset) {
			if (reset) {
				...
				return toys.text.blink(this,"default-blinker",gbox.getBufferContext(),{font:"small",text:"Game Start",valign:gbox.ALIGN_MIDDLE,halign:gbox.ALIGN_CENTER,dx:0,dy:0,dw:gbox.getScreenW(),dh:gbox.getScreenH(),blinkspeed:5,times:6});
			}
		 },
		...
		levelIntroAnimation:function(reset) {
			if (reset) {
				...
				gbox.blitFade(gbox.getBufferContext(),{alpha:1});
				return toys.text.blink(this,"default-blinker",gbox.getBufferContext(),{font:"consolas",text:"Level Start",valign:gbox.ALIGN_MIDDLE,halign:gbox.ALIGN_CENTER,dx:0,dy:0,dw:gbox.getScreenW(),dh:gbox.getScreenH(),blinkspeed:5,times:6});
			}
		 },
		 ...
		 newlifeIntroAnimation:function(reset) {
			 if (reset) {
				...
				gbox.blitFade(gbox.getBufferContext(),{alpha:1});
				return toys.text.fixed(this,"default-blinker",gbox.getBufferContext(),{font:"consolas",text:"Level Start",valign:gbox.ALIGN_MIDDLE,halign:gbox.ALIGN_CENTER,dx:0,dy:0,dw:gbox.getScreenW(),dh:gbox.getScreenH(),time:30});
			}
		},
		...
		gameoverIntroAnimation:function(reset) {
			 if (reset) {
				...
				gbox.blitFade(gbox.getBufferContext(),{alpha:1});
				return toys.text.fixed(this,"default-blinker",gbox.getBufferContext(),{font:"consolas",text:"Thank you so much for playing my game!",valign:gbox.ALIGN_MIDDLE,halign:gbox.ALIGN_CENTER,dx:0,dy:0,dw:gbox.getScreenW(),dh:gbox.getScreenH(),time:50});
			}
		},
