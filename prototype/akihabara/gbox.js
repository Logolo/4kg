...
var gbox={
	...
	_canlog:false,
	_splash:{
		gaugeLittleColor:"rgb(0,160,209)",
		gaugeLittleBackColor:"rgb(0,0,0)",
		gaugeBorderColor:"rgb(0,160,209)",
		gaugeBackColor:"rgb(0,0,0)",
		gaugeColor:"rgb(0,160,209)",
		gaugeHeight:10,
		background:null,
		minimalTime:0,
		footnotes:null,
  ...
  */  
	collides:function(o1,o2,t) {
		if (!t || o1.group !== 'foes' || o2.group !== 'foes') t = 0;
